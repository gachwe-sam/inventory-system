...
@section('content')
<div class="card">
    <div class="card-header"><h3 class="card-title mb-0">Edit Supplier</h3></div>
    <div class="card-body">
        <form method="POST" action="{{ route('suppliers.update', $supplier) }}">
            ...
            <div class="mb-3">
                ...
                <textarea name="description" rows="3" class="form-control">{{ old('description', $supplier->description) }}</textarea>
            </div>
            <div class="mb-3">
